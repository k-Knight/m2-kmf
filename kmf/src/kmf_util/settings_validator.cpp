...
"  - simple shield will now be removed in a\n"
"    network-synchronized manner\n"
"  - elemental wards were significantly buffed\n"
"  - beams now have some aim-assist to them\n"
"  - poison now has increased slowness debuff\n"
"  - friendly fire for elements that are not\n"
"    pushing players around was reduced\n"
"  - damage output of some other spells was\n"
"    re-balanced to allow for more play-styles\n"
;
