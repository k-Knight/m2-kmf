...
@@ -203,9 +216,12 @@ StatusSystemStatuses = {
...
+				damage_table.fire = internal.burning_dps * dot_dmg_mult
 
 				local burning_dealer_name = "other"
 				local burning_dealer = internal.last_burning_dealer
@@ -336,7 +352,19 @@ StatusSystemStatuses = {
...
@@ -1186,6 +1214,36 @@ StatusSystemStatuses = {
...
@@ -1222,79 +1280,160 @@ StatusSystemStatuses = {
 			end
 		end,
...
+	
+				if internal.kmf_poisoned_damage_time > 1 then
+					internal.kmf_poisoned_damage_time = 0
+	
+					local damage_table = FrameTable.alloc_table()
+					local player_ext = EntityAux.extension(u, "player")
...
+	
+					damage_table.poison = internal.kmf_poison_dps * dot_dmg_mult
+	
+					local poison_dealer_name = "other"
+					local poison_dealer = internal.last_poison_dealer
+	
