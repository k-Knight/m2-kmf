...
@@ -8,7 +8,7 @@ local elementsMapping = {
 	shield = "hud_element_shield_small",
 	water = "hud_element_water_small",
 	fire = "hud_element_fire_small",
-	lok = "hud_element_poison_small",
+	lok = "hud_icon_element_lok",
 	steam = "hud_element_steam_small",
 	earth = "hud_element_earth_small",
 	lightning = "hud_element_lightning_small",